  ...
  <form action="" method="POST">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="requesterstate" name="requesterstate" value="Madhya pradesh" readonly>
      </div>
      <div class="form-group col-md-4">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="requestermobile" name="requestermobile" max=="10" value="<?php if(isset($row['requestermobile'])) {echo $row['requestermobile']; }?>">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">

...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top bg-danger p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="dashboard.php">myhelper</a>
 </nav>
   ...
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <!-- <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'viewcontactus') { echo 'active'; } ?>" href="../viewcontactus.php">
